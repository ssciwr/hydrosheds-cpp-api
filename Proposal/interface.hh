...
class RiverData
{
    ...
    public:
        ...
        std::string get_next_river(const std::string& river_id) const;                          // returns next river after river (id)
        ...
        std::vector <double> get_associated_river_path(const std::string& river_id) const;      // returns vector path of rivers associated with river (id)
